...
public class Edge{
	 ...
	 */
	Edge(int eid,Node source, Node destination, double distance,float radius){
		this.id = eid;
		this.source = source;
	...
	Edge(int eid,Node source, Node destination, double distance,float radius, boolean flag){
		this.id = eid;
		this.source = source;
		this.destination = destination;
		this.distance = distance;
